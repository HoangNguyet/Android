...
public class MainTieuThuyet extends AppCompatActivity {

    ListView lv;
    StoryAdapter adapter;
    ArrayList<Story> tieuThuyetList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_tieu_thuyet);
    ...
    private void AnhXa() {
        ...
        Cursor cursor = db.getDataByGenre("Tiểu thuyết");
        while (cursor.moveToNext()) {
            ...
            if (titleIndex != -1 && imageIndex != -1) {
                ...
                tieuThuyetList.add(new Story(id, title, "", image,null));
        ...
        adapter = new StoryAdapter(getApplicationContext(), tieuThuyetList,this);
